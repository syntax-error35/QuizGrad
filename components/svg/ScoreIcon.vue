<template>
    <div>
        <svg viewBox="0 0 147 155" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M121.743 68.3608H24.938V152.049H121.743V68.3608Z" fill="url(#paint0_linear_14_515)" />
            <path d="M119.689 70.4233V149.986H27.0005V70.4233H119.689ZM123.814 66.2983H22.8755V154.111H123.814V66.2983Z"
                fill="#F0EBE6" />
            <path d="M27.0005 110.205H99.6005" stroke="#1A1F71" stroke-width="4.125" stroke-miterlimit="10" />
            <path d="M105.178 3L3 47.8954L13.6066 72.035L115.784 27.1396L105.178 3Z" fill="url(#paint1_linear_14_515)"
                stroke="#F0EBE6" stroke-width="4.125" stroke-miterlimit="10" />
            <path
                ...
                fill="#F0EBE6" stroke="url(#paint2_linear_14_515)" stroke-width="4.125" stroke-miterlimit="10" />
            <path d="M119.417 100.239V120.171" stroke="#FCC822" stroke-width="4.125" stroke-miterlimit="10" />
            <path d="M129.391 110.205H109.451" stroke="#FCC822" stroke-width="4.125" stroke-miterlimit="10" />
            <path
            ...
            <defs>
                <linearGradient id="paint0_linear_14_515" x1="54.2337" y1="162.708" x2="92.456" y2="57.6936"
                ...
                <linearGradient id="paint1_linear_14_515" x1="52.1046" y1="78.8275" x2="66.6741" y2="-3.78799"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#1A1F71" />
                    <stop offset="0.06" stop-color="#313A85" />
                    <stop offset="0.14" stop-color="#51609F" />
                ...
                <linearGradient id="paint2_linear_14_515" x1="115.622" y1="131.762" x2="123.22" y2="88.6476"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#A16A10" />
                    <stop offset="0.02" stop-color="#B88414" />
                    <stop offset="0.16" stop-color="#CF9F18" />
                    <stop offset="0.3" stop-color="#E5B71D" />
                    <stop offset="0.47" stop-color="#E8C52A" />
                    <stop offset="0.67" stop-color="#FABE1D" />
                    <stop offset="1" stop-color="#FCC822" />
                </linearGradient>
                <linearGradient id="paint3_linear_14_515" x1="126.199" y1="72.0568" x2="132.576" y2="35.9301"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#A16A10" />
                    <stop offset="0.02" stop-color="#B88414" />
                    <stop offset="0.16" stop-color="#CF9F18" />
